    ...
    return (
        <div>
            ...
            <div className='card-fs-content'>
                ...
                <p style={{fontSize: "14px",lineHeight:"18px"}}>3.5mm Jack Microphone Tie Clip-on Lapel Mikrofon</p>
            ...
            <div className='box'>
                ...
                <div style={{margin:'0.5rem'}}>
                <p style={{fontSize: "14px",lineHeight:"18px"}}>Unisex Binary LED Digital Date Square Dial Casual Sport Plastic </p>
            ...
            <div className='box'>
                ...
                <div style={{margin:'0.5rem'}}>
                <p style={{fontSize: "14px",lineHeight:"18px"}}>NEW STYLE Cotton Formal Shirt for Men </p>
                <p style={{color:'#f85606',fontSize: "18px"}}>৳ 103</p>
                </div>
            </div>
            ...
            <div className='box'>
                ...
                <div style={{margin:'0.5rem'}}>
                <p style={{fontSize: "14px",lineHeight:"18px"}}>New Blue Cotton Polo T- Shirt </p>
